...
import { Play, Settings, Palette, Music, Type, Wand2, Film, Sparkles } from 'lucide-react';
...
import { AIMovieStudio } from '../ai-movie/AIMovieStudio';
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto p-6">
        ...
        <Tabs defaultValue="ai-movie" className="w-full">
          <TabsList className="grid w-full grid-cols-7 bg-gray-800/50 border border-gray-700">
            <TabsTrigger value="ai-movie" className="flex items-center gap-2">
          ...
          <TabsContent value="ai-movie" className="mt-6">
            <AIMovieStudio />
          </TabsContent>
